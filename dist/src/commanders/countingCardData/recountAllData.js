...
function recountAllData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        users.forEach((user) => __awaiter(this, void 0, void 0, function* () {
            user.cards = yield Promise.all(user.cards.map((card) => __awaiter(this, void 0, void 0, function* () {
                ...
                card = Object.assign(Object.assign({}, card), newCard);
                return Object.assign(Object.assign({}, card), newCard);
            })));
            user.save();
        }));
